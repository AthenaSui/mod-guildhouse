...
REPLACE INTO `guild_house_spawns` (`id`, `entry`, `posX`, `posY`, `posZ`, `orientation`, `comment`) VALUES
    ...
    (27, 8719, 16243.5, 16291.2, 22.9312, 1.53658, 'Alliance Auctioneer'),
    (28, 9856, 16236.9, 16291.6, 22.931, 1.65753, 'Horde Auctioneer'),
    ...
    (55, 190013, 16241.4, 16292.1, 13.1757, 1.47929, '武器大师');
